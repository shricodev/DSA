...
rm ./$0.out > /dev/null
exit
 // This above is for linux user , you can directly chmod +x and run this . And other users can compile simply run it.
        // May be works for Mac user as well else, compile it then run . 
